...
export class Container extends pulumi.CustomResource {
    ...
    constructor(name: string, argsOrState?: ContainerArgs | ContainerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            inputs["storageOpts"] = state ? state.storageOpts : undefined;
            ...
            inputs["storageOpts"] = args ? args.storageOpts : undefined;
...
export interface ContainerState {
     ...
     * Key/value pairs for the storage driver options, e.g. `size`: `120G`
     */
    readonly storageOpts?: pulumi.Input<{[key: string]: any}>;
    /**
     * A map of kernel parameters (sysctls) to set in the container.
     */
