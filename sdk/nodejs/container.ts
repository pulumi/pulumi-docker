...
export class Container extends pulumi.CustomResource {
     ...
     */
    public readonly networksAdvanceds: pulumi.Output<{ aliases?: string[], ipv4Address?: string, ipv6Address?: string, name: string }[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ContainerArgs | ContainerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts && opts.id) {
            ...
            inputs["networksAdvanceds"] = state ? state.networksAdvanceds : undefined;
            ...
            inputs["networksAdvanceds"] = args ? args.networksAdvanceds : undefined;
...
export interface ContainerState {
     ...
     * See Networks Advanced below for details. If this block has priority to the deprecated `network_alias` and `network` properties.
     */
    readonly networksAdvanceds?: pulumi.Input<pulumi.Input<{ aliases?: pulumi.Input<pulumi.Input<string>[]>, ipv4Address?: pulumi.Input<string>, ipv6Address?: pulumi.Input<string>, name: pulumi.Input<string> }>[]>;
    /**
     * The PID (Process) Namespace mode for the container. Either `container:<name|id>` or `host`.
     */
