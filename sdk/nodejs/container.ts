...
export class Container extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ContainerState>, opts?: pulumi.CustomResourceOptions): Container {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ContainerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ContainerArgs> | pulumi.WrappedObject<ContainerState>, opts?: pulumi.CustomResourceOptions) {
