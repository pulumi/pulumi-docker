...
class Container(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if capabilities is not None and not isinstance(capabilities, ContainerCapabilitiesArgs):
                capabilities = capabilities or {}
                def _setter(key, value):
                    capabilities[key] = value
                ContainerCapabilitiesArgs._configure(_setter, **capabilities)
            ...
            if healthcheck is not None and not isinstance(healthcheck, ContainerHealthcheckArgs):
                healthcheck = healthcheck or {}
                def _setter(key, value):
                    healthcheck[key] = value
                ContainerHealthcheckArgs._configure(_setter, **healthcheck)
