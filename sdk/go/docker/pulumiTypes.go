...
func (i ProviderRegistryAuthArgs) ToProviderRegistryAuthPtrOutput() ProviderRegistryAuthPtrOutput {
	return i.ToProviderRegistryAuthPtrOutputWithContext(context.Background())
}

func (i ProviderRegistryAuthArgs) ToProviderRegistryAuthPtrOutputWithContext(ctx context.Context) ProviderRegistryAuthPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProviderRegistryAuthOutput).ToProviderRegistryAuthPtrOutputWithContext(ctx)
}

// ProviderRegistryAuthPtrInput is an input type that accepts ProviderRegistryAuthArgs, ProviderRegistryAuthPtr and ProviderRegistryAuthPtrOutput values.
// You can construct a concrete instance of `ProviderRegistryAuthPtrInput` via:
//
//          ProviderRegistryAuthArgs{...}
//
//  or:
//
//          nil
type ProviderRegistryAuthPtrInput interface {
	pulumi.Input

	ToProviderRegistryAuthPtrOutput() ProviderRegistryAuthPtrOutput
	ToProviderRegistryAuthPtrOutputWithContext(context.Context) ProviderRegistryAuthPtrOutput
}

type providerRegistryAuthPtrType ProviderRegistryAuthArgs

func ProviderRegistryAuthPtr(v *ProviderRegistryAuthArgs) ProviderRegistryAuthPtrInput {
	return (*providerRegistryAuthPtrType)(v)
}

func (*providerRegistryAuthPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ProviderRegistryAuth)(nil)).Elem()
}

func (i *providerRegistryAuthPtrType) ToProviderRegistryAuthPtrOutput() ProviderRegistryAuthPtrOutput {
	return i.ToProviderRegistryAuthPtrOutputWithContext(context.Background())
}

func (i *providerRegistryAuthPtrType) ToProviderRegistryAuthPtrOutputWithContext(ctx context.Context) ProviderRegistryAuthPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ProviderRegistryAuthPtrOutput)
}
...
func (o ProviderRegistryAuthOutput) ToProviderRegistryAuthPtrOutput() ProviderRegistryAuthPtrOutput {
	return o.ToProviderRegistryAuthPtrOutputWithContext(context.Background())
}

func (o ProviderRegistryAuthOutput) ToProviderRegistryAuthPtrOutputWithContext(ctx context.Context) ProviderRegistryAuthPtrOutput {
	return o.ApplyT(func(v ProviderRegistryAuth) *ProviderRegistryAuth {
		return &v
	}).(ProviderRegistryAuthPtrOutput)
}
...
type ProviderRegistryAuthPtrOutput struct{ *pulumi.OutputState }

func (ProviderRegistryAuthPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ProviderRegistryAuth)(nil)).Elem()
}

func (o ProviderRegistryAuthPtrOutput) ToProviderRegistryAuthPtrOutput() ProviderRegistryAuthPtrOutput {
	return o
}

func (o ProviderRegistryAuthPtrOutput) ToProviderRegistryAuthPtrOutputWithContext(ctx context.Context) ProviderRegistryAuthPtrOutput {
	return o
}

func (o ProviderRegistryAuthPtrOutput) Elem() ProviderRegistryAuthOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) ProviderRegistryAuth { return *v }).(ProviderRegistryAuthOutput)
}

func (o ProviderRegistryAuthPtrOutput) Address() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) *string {
		if v == nil {
			return nil
		}
		return &v.Address
...
func (o ProviderRegistryAuthPtrOutput) ConfigFile() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) *string {
		if v == nil {
			return nil
		}
...
func (o ProviderRegistryAuthPtrOutput) ConfigFileContent() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) *string {
		if v == nil {
			return nil
		}
		return v.ConfigFileContent
	}).(pulumi.StringPtrOutput)
}

func (o ProviderRegistryAuthPtrOutput) Password() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) *string {
		if v == nil {
			return nil
		}
...
func (o ProviderRegistryAuthPtrOutput) Username() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ProviderRegistryAuth) *string {
		if v == nil {
			return nil
		}
...
func (o RegistryImageBuildPtrOutput) Elem() RegistryImageBuildOutput {
	return o.ApplyT(func(v *RegistryImageBuild) RegistryImageBuild { return *v }).(RegistryImageBuildOutput)
}
...
func (o RemoteImageBuildPtrOutput) Elem() RemoteImageBuildOutput {
	return o.ApplyT(func(v *RemoteImageBuild) RemoteImageBuild { return *v }).(RemoteImageBuildOutput)
}
...
func (o ServiceTaskSpecContainerSpecPtrOutput) Elem() ServiceTaskSpecContainerSpecOutput {
	return o.ApplyT(func(v *ServiceTaskSpecContainerSpec) ServiceTaskSpecContainerSpec { return *v }).(ServiceTaskSpecContainerSpecOutput)
}
...
func init() {
	...
	pulumi.RegisterOutputType(ProviderRegistryAuthPtrOutput{})
