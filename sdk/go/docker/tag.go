...
func NewTag(ctx *pulumi.Context,
	...
	if args.TargetImage == nil {
		return nil, errors.New("invalid value for required argument 'TargetImage'")
	}
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Tag
	err := ctx.RegisterResource("docker:index/tag:Tag", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTag(ctx *pulumi.Context,
	...
	var resource Tag
	err := ctx.ReadResource("docker:index/tag:Tag", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o TagOutput) SourceImage() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.SourceImage }).(pulumi.StringOutput)
}
...
func (o TagOutput) TargetImage() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.TargetImage }).(pulumi.StringOutput)
}
