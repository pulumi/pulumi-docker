...
public final class BuildxBuilderState extends com.pulumi.resources.ResourceArgs {

    public static final BuildxBuilderState Empty = new BuildxBuilderState();
    ...
    private BuildxBuilderState() {}

    private BuildxBuilderState(BuildxBuilderState $) {
        this.append = $.append;
    ...
    public static Builder builder(BuildxBuilderState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BuildxBuilderState();
        }

        public Builder(BuildxBuilderState defaults) {
            $ = new BuildxBuilderState(Objects.requireNonNull(defaults));
        }
        ...
        public BuildxBuilderState build() {
            return $;
        }
    }
