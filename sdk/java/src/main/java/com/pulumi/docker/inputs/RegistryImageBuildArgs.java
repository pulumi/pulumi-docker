...
public final class RegistryImageBuildArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<String>> additionalContexts;
     ...
     * 
     */
    public Optional<Output<List<String>>> additionalContexts() {
    ...
    public static final class Builder {
        ...
        /**
         * @param additionalContexts A list of additional build contexts. Only supported when using a buildx builder. Example: `[&#34;name=path&#34;, &#34;src = https://example.org&#34;}`. Please see https://docs.docker.com/reference/cli/docker/buildx/build/#build-context for more information.
         * 
         * @return builder
         * 
         */
        public Builder additionalContexts(@Nullable Output<List<String>> additionalContexts) {
         ...
         * 
         */
        public Builder additionalContexts(List<String> additionalContexts) {
         ...
         * 
         */
        public Builder additionalContexts(String... additionalContexts) {
