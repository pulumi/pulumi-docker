...
public final class ServiceRollbackConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ServiceRollbackConfigArgs(ServiceRollbackConfigArgs $) {
        this.delay = $.delay;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceRollbackConfigArgs();
        }

        public Builder(ServiceRollbackConfigArgs defaults) {
            $ = new ServiceRollbackConfigArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param delay Delay between task rollbacks (ns|us|ms|s|m|h). Defaults to `0s`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param failureAction Action on rollback failure: pause | continue. Defaults to `pause`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param maxFailureRatio Failure rate to tolerate during a rollback. Defaults to `0.0`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param monitor Duration after each task rollback to monitor for failure (ns|us|ms|s|m|h). Defaults to `5s`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param order Rollback order: either &#39;stop-first&#39; or &#39;start-first&#39;. Defaults to `stop-first`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param parallelism Maximum number of tasks to be rollbacked in one iteration. Defaults to `1`
         * 
         * @return builder
         * 
         */
