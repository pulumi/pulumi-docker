...
public final class ServiceTaskSpecContainerSpecLabelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ServiceTaskSpecContainerSpecLabelArgs build() {
            if ($.label == null) {
                throw new MissingRequiredPropertyException("ServiceTaskSpecContainerSpecLabelArgs", "label");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("ServiceTaskSpecContainerSpecLabelArgs", "value");
            }
            return $;
        }
    }
