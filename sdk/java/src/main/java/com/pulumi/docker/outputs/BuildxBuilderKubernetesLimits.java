...
@CustomType
public final class BuildxBuilderKubernetesLimits {
    /**
    ...
    private BuildxBuilderKubernetesLimits() {}
    /**
     * @return CPU limit for the Kubernetes pod.
     * 
     */
    ...
    public static Builder builder(BuildxBuilderKubernetesLimits defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String memory;
        public Builder() {}
        public Builder(BuildxBuilderKubernetesLimits defaults) {
        ...
        public BuildxBuilderKubernetesLimits build() {
            final var _resultValue = new BuildxBuilderKubernetesLimits();
