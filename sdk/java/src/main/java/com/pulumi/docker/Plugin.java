...
public class Plugin extends com.pulumi.resources.CustomResource {
    ...
    public Plugin(java.lang.String name, @Nullable PluginArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("docker:index/plugin:Plugin", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Plugin(java.lang.String name, Output<java.lang.String> id, @Nullable PluginState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("docker:index/plugin:Plugin", name, state, makeResourceOptions(options, id), false);
    }
