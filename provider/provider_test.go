...
func TestDiff(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			news: resource.PropertyMap{
				...
				"build": resource.NewObjectProperty(resource.PropertyMap{
					"dockerfile": resource.NewStringProperty("Dockerfile"),
					"context":    resource.NewStringProperty("./new-context"),
				}),
			},
			want: &rpc.DiffResponse{
		...
		{
			name: "Changes in imageName",
			olds: resource.PropertyMap{
				"imageName": resource.NewStringProperty("docker.io/foo/bar:latest"),
			},
			news: resource.PropertyMap{
				"imageName": resource.NewStringProperty("docker.io/foo/baz:latest"),
			},
			want: &rpc.DiffResponse{
				Changes: rpc.DiffResponse_DIFF_SOME,
				DetailedDiff: map[string]*rpc.PropertyDiff{
		...
		{
			name: "Changes in registry server",
			olds: resource.PropertyMap{
				"registry": resource.NewObjectProperty(resource.PropertyMap{
					"server": resource.NewStringProperty("dockerhub"),
				}),
			},
			news: resource.PropertyMap{
				"registry": resource.NewObjectProperty(resource.PropertyMap{
					"server": resource.NewStringProperty("ShinyPrivateGHCR"),
				}),
			},
			want: &rpc.DiffResponse{
				Changes: rpc.DiffResponse_DIFF_SOME,
		...
		{
			name: "No changes on password update",
			olds: resource.PropertyMap{
				"registry": resource.NewObjectProperty(resource.PropertyMap{
					"password": resource.NewStringProperty("oldpassword"),
				}),
			},
			news: resource.PropertyMap{
				"registry": resource.NewObjectProperty(resource.PropertyMap{
					"password": resource.NewStringProperty("newpassword"),
				}),
			},
			want: &rpc.DiffResponse{
				Changes: rpc.DiffResponse_DIFF_NONE,
		...
		{
			name: "No changes on no registryAuth update",
			olds: resource.PropertyMap{
		...
		{
			name: "Changes on registryAuth address update",
			olds: resource.PropertyMap{
				"registryAuth": resource.NewArrayProperty([]resource.PropertyValue{
					resource.NewObjectProperty(resource.PropertyMap{
						"address":  resource.NewStringProperty("dockerhub"),
		...
		{
			name: "No changes on registryAuth username/password update",
			olds: resource.PropertyMap{
				"registryAuth": resource.NewArrayProperty([]resource.PropertyValue{
					resource.NewObjectProperty(resource.PropertyMap{
						"address":  resource.NewStringProperty("dockerhub"),
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			olds, err := plugin.MarshalProperties(tt.olds, plugin.MarshalOptions{KeepUnknowns: true})
			require.NoError(t, err)
